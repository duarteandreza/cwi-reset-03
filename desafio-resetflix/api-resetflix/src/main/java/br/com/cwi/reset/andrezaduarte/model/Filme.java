package br.com.cwi.reset.andrezaduarte.model;
...
public class Filme {
    ...
    public Filme(Integer idGerado, String s, Integer integer, String orElseThrow, List<Genero> generos, Diretor diretor, Estudio estudio, List<PersonagemAtor> personagemAtors, String elseThrow) {
    }
